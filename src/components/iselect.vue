<template>
    <div class="iselect" :style="{'width':selectWidth+'px'}">
      <input :value="selectValue" class="select-value" @focus="showSelectPart(0)" @blur="showSelectPart(1)" readonly />
      <i :class="[showSelect?'upTriangle':'']"><img src="/static/images/triangle.png" alt=""></i>
      <div class="select-container" v-show="showSelect">
        <ul>
